      ...
      <div class="am-u-md-6 am-cf">
        <div class="am-fl am-cf">
          ...
          <div class="am-form-group am-margin-left am-fl">
            <label>行业分类：</label>
            <select data-placeholder="请选择行业分类" id="info-category">
...
<script>
  ...
  export default {
    ...
    data(){
      ...
      ;
      let adsense_index = vm.$route.params.index;
      let infos = [];
      let sites = [];
      // 当前选择的站点
      let selected_site = {};
    ...
    watch: {
      '$route': 'refresh'　　　　// 如果路由有变化，会再次执行fetchData方法
    },
    methods: {
      querySites: async() => {
      ...
      // 查询站点广告
      queryAdsenses: async() => {
        let response = await API.Adsenses.get({id: vm.current_site_id, index: vm.adsense_index});
        if (response.ok) {
